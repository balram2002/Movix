...
const RecommendationSection = ({ tvShow, title }) => {
  ...
  return <CustomLiked1 data={data} loading={loading} endpoint={tvShow.media_type} title={title} />;
};
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="TV shows page of moviesverse where users can explore and Discover millions of tv shows and web shows. Moviesverse - Explore and stream millions of movies, tv shows, animes, web shows etc for free."
        />
        ...
        <div className="homePage">
          ...
          {recommendationItems[0] && (
            <RecommendationSection
              key={recommendationItems[0].tvShow.id}
              tvShow={recommendationItems[0].tvShow}
          ...
          {recommendationItems[1] && (
            <RecommendationSection
              key={recommendationItems[1].tvShow.id}
              tvShow={recommendationItems[1].tvShow}
          ...
          {recommendationItems[2] && (
            <RecommendationSection
              key={recommendationItems[2].tvShow.id}
              tvShow={recommendationItems[2].tvShow}
          ...
          {recommendationItems[3] && (
            <RecommendationSection
              key={recommendationItems[3].tvShow.id}
              tvShow={recommendationItems[3].tvShow}
          ...
          {recommendationItems[4] && (
            <RecommendationSection
              key={recommendationItems[4].tvShow.id}
              tvShow={recommendationItems[4].tvShow}
