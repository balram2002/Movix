...
import './ShowDetails2.css';
import './ShowDetails2.scss';
...
const ShowDetails2 = ({ data, video, crew }) => {
  ...
  return (
    <>
      ...
      <div className='!mb-[40px]'>
        <h2 className="similar-shows-title text-left">Similar {mediaType === 'tv' ? 'TV Shows' : 'Movies'}</h2>
        <div className="similar-shows-list mb-5">
