...
import BuyMeACoffeeBanner from "../../home/BuyMeACoffe/BuyMeACoffee.jsx";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Movies and TV shows details page of moviesverse where users can view movies/tv shows details and their roles, trailer, cast, videos, collections, seasons, episodes and recommneded/similar movies/tv shows. Moviesverse - Explore and stream millions of movies, tv shows, animes, web shows etc for free."
        />
                ...
                <ContentWrapper>
                  <div className="content">
                    ...
                    <div className="auth-icons-details">
                      ...
                      >
                        <FaRegHeart className="liked-icon" />
                      </span>
                      <span
                        onClick={() => {
                          saveWatchList(data);
                      ...
                      >
                        <MdOutlineBookmarkAdd className="watch-icon" />
                      </span>
                    </div>
                    <div className="shareicon989-details">
                      <RWebShare
                        data={{
                          text: `Moviesverse shared ${data?.endpoint || mediaType} ${
                            data?.name || data?.title
                          } ( ${releaseYear} ) with a tagline of '${data?.tagline}'.`,
                          url: `https://www.moviesverse.studio/${data?.endpoint || mediaType}/${id | data?.id}`,
                          title: ("Movix Shared " + data?.name) | data?.title,
                        }}
                      >
                        <span>
                          <FaShareSquare className="shareicon98icon" />
                        </span>
                      </RWebShare>
                    </div>
                    <div className="left">
                      ...
                      <div className="info">
                        {data?.first_air_date && (
                          <div className="infoItem">
                            ...
                            <span className="text">{dayjs(data?.air_date).format("MMM D, YYYY")}</span>
                          </div>
                        )}
                        {data?.original_language && (
                          <div className="infoItem">
                            <span className="text bold">Original Language: </span>
                            <span className="text">
                        ...
                        {!data?.origin_country && (
                          <div className="infoItem">
                            <span className="text bold">Content Type: </span>
                            <span className="text">{mediaType}</span>
                          </div>
                        )}

                        {data?.origin_country && (
                          <div className="infoItem">
                            <span className="text bold">Origin Country: </span>
                            <span className="text">
                        ...
                        {data?.revenue && (
                          <div className="infoItem">
                            ...
                            <span className="text">$ {data.revenue}</span>
                          </div>
                        )}
                      </div>
